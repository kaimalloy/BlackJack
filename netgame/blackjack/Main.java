...
/**
 * A main class for the network Five Card Draw Poker game. Main routine shows a
 * dialog where the user can choose to be a server or a client. If the user
 * chooses to be a server, then a PokerHub is created to manage the game; the
 * game will not start until a second player has connected as a client. To act
 * as a client, the user must know the host name or IP address of the computer
 * and the port number where the server is waiting for a connection. When run as
 * a client, this program does not create a hub; rather, it connects to the hub
 * that was created by the server. In either case, a PokerWindow is created
...
public class Main
{
    ...
    public static void main( String[] args )
    {
        ...
        JLabel message = new JLabel( "Welcome to NetBlackJack!", JLabel.CENTER );
        ...
        while ( true )
        { // Repeats until a game is started or the user cancels.
